...
\textbf{Sentence length effects.} As shown in Figure~\ref{fig:bleu_by_length}, all models perform worse on longer sentences. Our model is the most robust, holding up relatively well even for sentences of 40--50+ words, while Baseline~2 degrades the fastest.
